...
text_recognition_url = endpoint + "/vision/v3.2/read/analyze?language=es"
...
image_path = '/Users/marya/Desktop/es.png'
...
for polygon in polygons:
    ...
    plt.text(vertices[0][0], vertices[0][1], text, fontsize=6, va="center")
plt.show()
